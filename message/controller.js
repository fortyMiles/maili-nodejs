...
var get_message_by_unique_code = function(_get_url, ip, port, req, res){
...
var get_history_p2p_message = function(_get_url, ip, port, req, res){
...
var get_message_by_unique_code_from_local_host = _.curry(get_message_by_unique_code)(_get_url, IP, PORT);
var get_history_p2p_message_from_local_host = _.curry(get_history_p2p_message)(_get_url, IP, PORT);
